...
class Contact < ApplicationRecord
  ...
  include Loggable
  # TASK-035: Broadcast logic for real-time updates (extracted concern)
  include ContactBroadcastable
  ...
  # calculate_visible_user_ids, fetch_team_user_ids, broadcast_notification_badge_update,
  # broadcast_contact_list_update) are defined in Contact::Broadcastable concern
end
