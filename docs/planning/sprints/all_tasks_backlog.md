...
|--------|-------|----------|-------|
| Sprint 1 | Foundation | Week 1-2 | 16 |
| Sprint 2 | Core Features (Part 1) | Week 3-4 | 18 |
| Sprint 3 | Core Features (Part 2) | Week 5 | 12 |
| Sprint 4 | Feature Finish (Noti, Dashboard) | Week 6-7 | 20 |
| Sprint 5 | Verification & Deployment | Week 8 | 5 |
...
**Acceptance Criteria:**
- [ ] Application layout với sidebar, header, main content area
- [ ] Tailwind theme setup (colors theo brand An Khang)
- [ ] Base components: Button, Input, Card, Table, Alert, Modal
- [ ] Responsive navigation (mobile sidebar toggle)
- [ ] Flash messages styling (success, error, warning)
- [ ] Typography system (headings, body text)
- [ ] Dark mode ready (optional)

**Test Cases:**
- [ ] Layout render đúng trên desktop (>1024px)
- [ ] Layout responsive trên mobile (<768px)
- [ ] Sidebar toggle hoạt động trên mobile
- [ ] All base components render đúng

**Related:** Wireframes trong `docs/ui-design/wireframes/`

---

### TASK-007: Core Migrations - Users & Auth
| Field | Value |
|-------|-------|
| **Epic** | Database Schema |
| **Story Points** | 3 |
...
### TASK-009: Core Migrations - Teams
| Field | Value |
|-------|-------|
| **Epic** | Database Schema |
| **Story Points** | 2 |
...
### TASK-011: Devise Setup & Configuration
| Field | Value |
|-------|-------|
| **Epic** | Authentication |
| **Story Points** | 3 |
...
### TASK-015: CanCanCan Ability Class
| Field | Value |
|-------|-------|
| **Epic** | Authorization |
| **Story Points** | 5 |
...
### TASK-019: Contact Model & Migrations
| Field | Value |
|-------|-------|
| **Epic** | Contacts |
| **Story Points** | 3 |
...
### TASK-022: Pick Contact (⚠️ Critical)
| Field | Value |
|-------|-------|
| **Epic** | Contacts |
| **Story Points** | 8 |
...
# Sprint 4: Feature Finish (Notifications & Dashboard) (Week 6-7)

### TASK-029: Notification Rules Engine
| Field | Value |
|-------|-------|
| **Epic** | Notifications |
| **Story Points** | 8 |
...
### TASK-030: Web Push Notifications
| Field | Value |
|-------|-------|
| **Epic** | Notifications |
| **Story Points** | 5 |
...
# Sprint 5: Verification & Deployment (Week 8)
...
### TASK-036: Production Deployment
| Field | Value |
|-------|-------|
| **Epic** | Deployment |
| **Story Points** | 8 |
